/**
 * An example third-party-style skill manifest, authored using ONLY the
 * public SDK types (`SkillManifest` from `../../src/sdk.js` — a real
 * external author would import this from the package's public `foreman/sdk`
 * entry point instead of a relative path, but the surface used is identical
 * either way).
 *
 * Domain: Performance Review — deliberately a 4th domain, distinct from the
 * three bundled skills (research/architecture/security), to prove this
 * isn't secretly reusing bundled-skill internals.
 */
import type { SkillManifest } from '../../src/sdk.js'

export const manifest: SkillManifest = {
  id: 'performance-review',
  name: 'Performance Review',
  description: 'Hot-path latency, N+1 queries, unbounded allocation, and unbounded concurrency concerns.',
  procedure: `You are the Performance specialist inside an autonomous coding harness. You are
